...
INSERT ALL
    ...
    INTO car (car_id, car_make, car_type, car_model, car_dailyrent, car_plateno, car_passengers, car_color, car_doors, car_transmission, car_fueltype, car_gps, car_bluetooth, car_aircon, car_condition) 
    VALUES (20, 'Tesla', 'SUV', 'Model S', 50.00, 'ZAB890', 7, 'Black', 4, 'Automatic', 'NA', 'Yes', 'Yes', 'Yes', 'New')
SELECT * FROM dual;
...
INSERT ALL 
    ...
    VALUES (1, TO_DATE('01-Feb-01', 'DD-Mon-YY'), TO_DATE('11-Feb-2023', 'DD-Mon-YY'), TO_DATE('13-Feb-2023', 'DD-Mon-YY'), 'Vancouver', 2, 'Approved', 1, 1, 2)
    INTO reservation(reservation_id, reservation_date, reservation_pickup, reservation_return, reservation_location, reservation_duration, reservation_status, inventory_id, customer_id, employee_id)
    VALUES (2, TO_DATE('12-Feb-2023', 'DD-Mon-YY'), TO_DATE('15-Feb-2023', 'DD-Mon-YY'), TO_DATE('17-Feb-2023', 'DD-Mon-YY'), 'Richmond', 2, 'Approved', 2, 2, 3)
    INTO reservation(reservation_id, reservation_date, reservation_pickup, reservation_return, reservation_location, reservation_duration, reservation_status, inventory_id, customer_id, employee_id)
    VALUES (3, TO_DATE('24-Feb-2023', 'DD-Mon-YY'), TO_DATE('26-Feb-2023', 'DD-Mon-YY'), TO_DATE('01-Mar-2023', 'DD-Mon-YY'), 'Burnaby', 3, 'Approved', 3, 3, 4)
    INTO reservation(reservation_id, reservation_date, reservation_pickup, reservation_return, reservation_location, reservation_duration, reservation_status, inventory_id, customer_id, employee_id)
    VALUES (4, TO_DATE('04-Mar-2023', 'DD-Mon-YY'), TO_DATE('06-Mar-2023', 'DD-Mon-YY'), TO_DATE('14-Mar-2023', 'DD-Mon-YY'), 'Vancouver', 8, 'Approved', 4, 4, 5)
    INTO reservation(reservation_id, reservation_date, reservation_pickup, reservation_return, reservation_location, reservation_duration, reservation_status, inventory_id, customer_id, employee_id)
    VALUES (5, TO_DATE('17-Mar-2023', 'DD-Mon-YY'), TO_DATE('18-Mar-2023', 'DD-Mon-YY'), TO_DATE('22-Mar-2023', 'DD-Mon-YY'), 'Richmond', 4, 'Approved', 5, 5, 6)
    INTO reservation(reservation_id, reservation_date, reservation_pickup, reservation_return, reservation_location, reservation_duration, reservation_status, inventory_id, customer_id, employee_id)
    VALUES (6, TO_DATE('15-Feb-2023', 'DD-Mon-YY'), TO_DATE('20-May-2023', 'DD-Mon-YY'), TO_DATE('28-May-2023', 'DD-Mon-YY'), 'Vancouver', 8, 'Approved', 1, 6, 2)
    INTO reservation(reservation_id, reservation_date, reservation_pickup, reservation_return, reservation_location, reservation_duration, reservation_status, inventory_id, customer_id, employee_id) 
    VALUES (7, TO_DATE('23-Feb-23', 'DD-Mon-YY'), TO_DATE('22-May-23', 'DD-Mon-YY'), TO_DATE('31-May-23', 'DD-Mon-YY'), 'Richmond', 9, 'Approved', 2, 7, 3)
    INTO reservation(reservation_id, reservation_date, reservation_pickup, reservation_return, reservation_location, reservation_duration, reservation_status, inventory_id, customer_id, employee_id) 
    VALUES (8, TO_DATE('28-Feb-23', 'DD-Mon-YY'), TO_DATE('25-May-23', 'DD-Mon-YY'), TO_DATE('29-May-23', 'DD-Mon-YY'), 'Burnaby', 4, 'Approved', 3, 8, 4)
    INTO reservation(reservation_id, reservation_date, reservation_pickup, reservation_return, reservation_location, reservation_duration, reservation_status, inventory_id, customer_id, employee_id) 
    VALUES (9, TO_DATE('14-Mar-23', 'DD-Mon-YY'), TO_DATE('25-May-23', 'DD-Mon-YY'), TO_DATE('1-Jun-23', 'DD-Mon-YY'), 'Vancouver', 7, 'Approved', 4, 9, 5)
    INTO reservation(reservation_id, reservation_date, reservation_pickup, reservation_return, reservation_location, reservation_duration, reservation_status, inventory_id, customer_id, employee_id) 
    VALUES (10, TO_DATE('17-Mar-23', 'DD-Mon-YY'), TO_DATE('28-May-23', 'DD-Mon-YY'), TO_DATE('6-Jun-23', 'DD-Mon-YY'), 'Richmond', 9, 'Approved', 5, 10, 6)
    INTO reservation(reservation_id, reservation_date, reservation_pickup, reservation_return, reservation_location, reservation_duration, reservation_status, inventory_id, customer_id, employee_id) 
    VALUES (11, TO_DATE('24-Feb-23', 'DD-Mon-YY'), TO_DATE('30-May-23', 'DD-Mon-YY'), TO_DATE('8-Jun-23', 'DD-Mon-YY'), 'Burnaby', 9, 'Disapproved', 6, 11, 7)
    INTO reservation(reservation_id, reservation_date, reservation_pickup, reservation_return, reservation_location, reservation_duration, reservation_status, inventory_id, customer_id, employee_id) 
    VALUES (12, TO_DATE('2-Mar-23', 'DD-Mon-YY'), TO_DATE('1-Jun-23', 'DD-Mon-YY'), TO_DATE('10-Jun-23', 'DD-Mon-YY'), 'Vancouver', 9, 'Approved', 7, 12, 8)
    INTO reservation(reservation_id, reservation_date, reservation_pickup, reservation_return, reservation_location, reservation_duration, reservation_status, inventory_id, customer_id, employee_id) 
    VALUES (13, TO_DATE('2-Mar-23', 'DD-Mon-YY'), TO_DATE('2-Jun-23', 'DD-Mon-YY'), TO_DATE('11-Jun-23', 'DD-Mon-YY'), 'Richmond', 9, 'Disapproved', 8, 13, 9)
    INTO reservation(reservation_id, reservation_date, reservation_pickup, reservation_return, reservation_location, reservation_duration, reservation_status, inventory_id, customer_id, employee_id) 
    VALUES (14, TO_DATE('25-Mar-23', 'DD-Mon-YY'), TO_DATE('3-Jun-23', 'DD-Mon-YY'), TO_DATE('6-Jun-23', 'DD-Mon-YY'), 'Burnaby', 3, 'Pending', 9, 14, 11)
    INTO reservation(reservation_id, reservation_date, reservation_pickup, reservation_return, reservation_location, reservation_duration, reservation_status, inventory_id, customer_id, employee_id) 
    VALUES (15, TO_DATE('27-Mar-23', 'DD-Mon-YY'), TO_DATE('5-Jun-23', 'DD-Mon-YY'), TO_DATE('10-Jun-23', 'DD-Mon-YY'), 'Vancouver', 5, 'Pending', 10, 15, 12)
SELECT 1 FROM DUAL;
...
INSERT ALL
    ...
    VALUES (1, 80.00, TO_DATE('01-Feb-23', 'DD-Mon-YY'), 1, 1)
    INTO payment(payment_id, payment_amount, payment_date,reservation_id, customer_id)
    VALUES (2, 100.00, TO_DATE('12-Feb-23', 'DD-Mon-YY'), 2, 2)
    INTO payment(payment_id, payment_amount, payment_date,reservation_id, customer_id)
    VALUES (3, 225.00, TO_DATE('24-Feb-23', 'DD-Mon-YY'), 3, 3)
    INTO payment(payment_id, payment_amount, payment_date,reservation_id, customer_id)
    VALUES (4, 320.00, TO_DATE('04-Mar-23', 'DD-Mon-YY'), 4, 4)
    INTO payment(payment_id, payment_amount, payment_date,reservation_id, customer_id)
    VALUES (5, 200.00, TO_DATE('17-Mar-23', 'DD-Mon-YY'), 5, 5)
    INTO payment(payment_id, payment_amount, payment_date,reservation_id, customer_id)
    VALUES (6, 320.00, TO_DATE('15-Feb-23', 'DD-Mon-YY'), 6, 6)
    INTO payment(payment_id, payment_amount, payment_date,reservation_id, customer_id)
    VALUES (7, 450.00, TO_DATE('23-Feb-23', 'DD-Mon-YY'), 7, 7)
    INTO payment(payment_id, payment_amount, payment_date,reservation_id, customer_id)
    VALUES (8, 300.00, TO_DATE('28-Feb-23', 'DD-Mon-YY'), 8, 8)
    INTO payment(payment_id, payment_amount, payment_date,reservation_id, customer_id)
    VALUES (9, 280.00, TO_DATE('14-Mar-23', 'DD-Mon-YY'), 9, 9)
    INTO payment(payment_id, payment_amount, payment_date,reservation_id, customer_id)
    VALUES (10, 450.00, TO_DATE('17-Mar-23', 'DD-Mon-YY'), 10, 10)
    INTO payment(payment_id, payment_amount, payment_date,reservation_id, customer_id)
    VALUES (11, 360.00, TO_DATE('24-Feb-23', 'DD-Mon-YY'), 11, 11)
    INTO payment(payment_id, payment_amount, payment_date,reservation_id, customer_id) 
    VALUES (12, 450.00, TO_DATE('02-Mar-23', 'DD-Mon-YY'), 12, 12)
    INTO payment(payment_id, payment_amount, payment_date,reservation_id, customer_id) 
    VALUES (13, 675.00, TO_DATE('02-Mar-23', 'DD-Mon-YY'), 13, 13)
    INTO payment(payment_id, payment_amount, payment_date,reservation_id, customer_id)
    VALUES (14, 120.00, TO_DATE('25-Mar-23', 'DD-Mon-YY'), 14, 14)
    INTO payment(payment_id, payment_amount, payment_date,reservation_id, customer_id) 
    VALUES (15, 250.00, TO_DATE('27-Mar-23', 'DD-Mon-YY'), 15, 15)
SELECT 1 FROM dual;
